...
public class downLoadTest02 {
    ...
    public static File downloadFile(String urlPath, String downloadDir) {
        ...
        try {
        	...
        	BufferedInputStream bin = new BufferedInputStream(new FileInputStream(urlPath));
        	long fileLength = file.length();
            String path = downloadDir + File.separatorChar + file.getName();
            file = new File(path);
    ...
    public static void main(String[] args) {
        ...
        // 下载文件测试
        downloadFile("E:\\2017-03-31-7.xls", "D:");
